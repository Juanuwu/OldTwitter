...
=======
        ...
        <div class="${u.blocking ? '' : 'not-blocked'}">
>>>>>>> parent of d6a6fa8d (Merge branch 'master' into personal)
...
=======
                    <span${u.id_str === '1708130407663759360' ? ' title="Old Twitter Layout extension developer"' : ''} class="tweet-header-name user-item-name ${usernameClass} ${u.protected ? ' user-protected' : ''}${followed_by_friend ? ' user-followed-by-friend' : ''}${u.muting ? ' user-muted' : ''}${u.verified || u.verified_type ? ' user-verified' : u.id_str === '1708130407663759360' ? ' user-verified user-verified-dimden' : ''} ${u.verified_type === 'Government' ? 'user-verified-gray' : u.verified_type === 'Business' ? 'user-verified-yellow' : u.verified_type === 'Blue' ? 'user-verified-blue' : ''}">${escapeHTML(u.name)}</span><br>
>>>>>>> parent of d6a6fa8d (Merge branch 'master' into personal)
